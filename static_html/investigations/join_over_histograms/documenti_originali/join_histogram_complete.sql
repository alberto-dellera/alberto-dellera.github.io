...
--
-- The complete example used to illustrate all aspects of the formula.
--
...
spool join_histogram_complete.lst
...
insert into t1(value) values (20  );
insert into t1(value) values (20.5);
...
exec dbms_stats.gather_table_stats (user, 't1', method_opt=>'for all columns size 6', estimate_percent=>100);
...
insert into t2(value) select  30 from dual connect by level <= 2;
insert into t2(value) values (50);
insert into t2(value) select  60 from dual connect by level <= 4;
insert into t2(value) select  70 from dual connect by level <= 2;
insert into t2(value) select  80 from dual connect by level <= 2;
insert into t2(value) values (90);
